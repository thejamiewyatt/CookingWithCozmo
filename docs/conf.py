...
# -*- coding: utf-8 -*-
#
# Cozmo Taste Game documentation build configuration file, created by
...
htmlhelp_basename = 'CozmoTasteGamedoc'
...
latex_documents = [
    (master_doc, 'CozmoTasteGame.tex', 'Cozmo Taste Game Documentation',
     'The Cozmopolitans', 'manual'),
]
